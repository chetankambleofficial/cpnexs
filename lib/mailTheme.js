...
export const COMPANY_WEBSITE = "https://www.cpnexs.in";
export const COMPANY_TAGLINE = "Software Development Company — Hubli & Bangalore";
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td style="padding:28px 32px 16px 32px;text-align:center;">
            <img src="${LOGO_BASE64}" alt="${COMPANY_NAME}" width="120"
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td align="center" style="padding-bottom:12px;">
            <img src="${LOGO_BASE64}" alt="${COMPANY_NAME}" width="80"
