...
export const metadata = {
  ...
  keywords: [
    "CPNexs", "Web Development", "AI Solutions", "Next.js Development",
    "Cloud Solutions", "SEO Services", "Mobile App Development",
    "Digital Agency", "Business Growth", "Software Development",
  ],
  authors: [{ name: "CPNexs" }],
  creator: "CPNexs",
  publisher: "CPNexs",
  ...
  openGraph: {
    ...
    description: "We build high-performing websites, AI tools, and digital systems for ambitious businesses.",
    url: "https://cpnexs-pduwyll2g-chetan582003-1296s-projects.vercel.app",
    siteName: "CPNexs",
    images: [{ url: "/images/favicon.png", width: 1200, height: 630, alt: "CPNexs" }],
    locale: "en_US",
    type: "website",
  },
  twitter: {
    ...
    description: "Modern websites, AI solutions, and scalable digital systems for growing businesses.",
    images: ["/images/favicon.png"],
  },
  robots: { index: true, follow: true },
  icons: {
    icon: [{ url: "/images/favicon.png", type: "image/png" }, { url: "/images/favicon.png", sizes: "any" }],
